...
from bert.modeling import BertForSequenceClassification, BertConfig, BertForSequenceClassification_Ss_IDW_neg_multiply,BertForSequenceClassification_Ss_IDW_weight
...
def main():
    ...
    if args.do_train:
        ...
        model = BertForSequenceClassification_Ss_IDW_weight.from_pretrained(args.bert_model,
                                                                      cache_dir=cache_dir,
                                                                      num_labels=num_labels)
        ...
        model = BertForSequenceClassification_Ss_IDW_weight.from_pretrained(args.output_dir, num_labels=num_labels)
    model.to(device)
