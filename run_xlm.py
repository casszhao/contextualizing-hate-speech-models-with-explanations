...
def main():
    ...
    tokenizer = XLMTokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case)
    ...
    if args.do_train:
        model = XLMForSequenceClassification.from_pretrained(args.bert_model,
                                                              cache_dir=cache_dir,
                                                              num_labels=num_labels)


    else:
        model = XLMForSequenceClassification.from_pretrained(args.output_dir, num_labels=num_labels)
    model.to(device)
